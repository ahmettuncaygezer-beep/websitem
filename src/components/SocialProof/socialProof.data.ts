...
export const INSTAGRAM_POSTS: InstagramPost[] = [
    {
        ...
        location: 'İstanbul',
        tags: ['selis', 'evdekorasyonu', 'minimalist'],
    },
    {
        id: '2',
        ...
        location: 'Ankara',
        tags: ['yemekodası', 'selis', 'ahşapmasa'],
    },
    {
        id: '3',
