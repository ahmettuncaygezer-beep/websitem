...
"[project]/src/app/api/press/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from('press_items').select('*').eq('is_active', true).order('sort_order', {
            ascending: true
        });
        if (error) {
            // Table not found — return empty list gracefully
...
//# sourceMappingURL=%5Broot-of-the-server%5D__95c16672._.js.map